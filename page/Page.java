package com.example.springBootTest.page;
...
public class Page {
	...
	String accountDivision;
	String accountFindStr;
	int totList;
	int listSize = 10;
	int blockSize = 5;
	int totPage;
	...
	public String getAccountFindStr() {
		return accountFindStr;
	}
	public void setAccountFindStr(String accountFindStr) {
		this.accountFindStr = accountFindStr;
	}
